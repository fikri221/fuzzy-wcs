                    ...
                    <div class="card-body col-lg-12 p-0">
                        ...
                        <div class="text-center">
                            <div class="p-5">
                                ...
                                <form id="login-form" name="login-form" class="user" action="validasi.php?action=login" method="POST">
                                    <div class="form-group">
                                        <input type="text" class="form-control form-control-user" id="login-form-username" name="login-form-username" value="" aria-describedby="usernameHelp" placeholder="Username" />
                                    </div>
                                    <div class="form-group">
