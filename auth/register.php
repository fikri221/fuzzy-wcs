                    ...
                    <div class="card-body col-lg-12 p-0">
                        ...
                        <div class="text-center">
                            <div class="p-5">
                                ...
                                <form id="register-form" name="register-form" class="user" action="validasi.php?action=register" method="POST">
                                    <div class="form-group">
                                        <input type="text" class="form-control form-control-user" id="register-form-username" name="register-form-username" value="" placeholder="Username" />
                                    </div>
                                    <div class="form-group">
